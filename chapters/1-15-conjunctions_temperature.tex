...
Instead, use the multiple-\textit{li} technique  (Page~\pageref{sssec:multiple_li}) or split the sentence into two sentences.

Also note that \textit{en} is not intended to connect two direct objects.
For that, use the multiple-\textit{e} technique (Page~\pageref{sssec:multiple_e}).
