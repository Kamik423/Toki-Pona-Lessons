...
\begin{supertabular}{p{2,5cm}|ll}
    ...
    %
    \index{monsuta}
    \textbf{\dots monsuta}    &  & \textit{adjective} (unofficial): fearful, afraid                                                  \\ % no-dictionary
    \textbf{monsuta}          &  & \textit{noun} (unofficial): monster, monstrosity, fearful thing, fright, mythical creatures, fear \\ % no-dictionary
                              &  &                                                                                                   \\ % no-dictionary
    %
    \index{namako}
