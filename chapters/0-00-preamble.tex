...
% \titleformat{\chapter}[block]{\normalfont\huge\bfseries}{\thechapter}{0pt}{\hspace{20pt}\huge}
\titlespacing*{\chapter}{0pt}{0pt}{30pt}
\sectionfont{\color{tppink}}
% \subsectionfont{\color{tppink}}

% Use to format toki pona text
\newcommand{\tpfamily}{\merriweather}
\newcommand{\texttp}[1]{{\tpfamily#1}}
...
\NewEnviron{vocabularytable}{%
    \begin{table}[H]
        ...
        \colorbox{tpgray}{%
            ...
            \begin{tabularx}{\linewidth}{l!{\color{white}\vrule width 2pt}X}
