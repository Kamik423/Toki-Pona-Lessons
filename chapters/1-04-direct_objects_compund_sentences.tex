...
\begin{vocabularytable}
    \dots{} e \dots{}  & \wordtype{separator}: An \texttp{e} introduces a direct object. Don't use \texttp{e} before or after the other separators. \\
    \wordrule %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ijo                & \wordtype{noun}: thing, something, stuff, anything, object                                                                 \\
    \dots{} ijo        & \wordtype{adjective}, \wordtype{adverb}: of something                                                                      \\
    ijo (e \dots{})    & \wordtype{verb transitive}: to objectify                                                                                   \\
    \wordrule %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ilo                & \wordtype{noun}: tool, device, machine, thing used for a specific purpose                                                  \\
    \dots{} ilo        & \wordtype{adjective}: useful                                                                                               \\
                       & \wordtype{adverb}: usefully                                                                                                \\
    \wordrule %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    jo                 & \wordtype{noun}: having, possessions, content                                                                              \\
    \dots{} jo         & \wordtype{adjective}: private, personal                                                                                    \\
    jo (e \dots{})     & \wordtype{verb transitive}: to have, to contain                                                                            \\
    \wordrule %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    kili               & \wordtype{noun}: fruit, pulpy vegetable, mushroom                                                                          \\
    \dots{} kili       & \wordtype{adjective}, \wordtype{adverb}: fruity                                                                            \\
    \wordrule %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    lukin              & \wordtype{noun}: view, look, glance, sight, gaze, glimpse, seeing, vision                                                  \\
    \dots{} lukin      & \wordtype{adjective}: visual                                                                                               \\
                       & \wordtype{adverb}: visually                                                                                                \\
                       & \wordtype{verb intransitive}: to look, to watch out, to pay attention                                                      \\
    lukin (e \dots{})  & \wordtype{verb transitive}: to see, to look at, to watch, to read                                                          \\
    lukin \dots{}      & \wordtype{auxiliary verb}: to seek to, try to, look for                                                                    \\
    \wordrule %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ma                 & \wordtype{noun}: land, earth, country, (outdoor) area                                                                      \\
    \dots{} ma         & \wordtype{adjective}: countrified, outdoor, alfresco, open-air                                                             \\
    \wordrule %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    pakala             & \wordtype{noun}: blunder, accident, mistake, destruction, damage, breaking                                                 \\
    \dots{} pakala     & \wordtype{adjective}, \wordtype{adverb}: destroyed, ruined, demolished, shattered, wrecked                                 \\
                       & \wordtype{verb intransitive}: to screw up, to fall apart, to break                                                         \\
    pakala (e \dots{}) & \wordtype{verb transitive}: to screw up, to ruin, to break, to hurt, to injure, to damage                                  \\
    \wordrule %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    unpa               & \wordtype{noun}: sex, sexuality                                                                                            \\
    \dots{} unpa       & \wordtype{adjective}, \wordtype{adverb}: erotic, sexual                                                                    \\
                       & \wordtype{verb intransitive}: to have sex                                                                                  \\
    unpa (e \dots{})   & \wordtype{verb transitive}: to have sex with, to sleep with, to fuck                                                       \\
    \wordrule %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    wile               & \wordtype{noun}: desire, need, will                                                                                        \\
    wile (e \dots{})   & \wordtype{verb transitive}: to want, need, wish, have to, must, will, should                                               \\
    wile \dots{}       & \wordtype{auxiliary verb}: to want, need, wish, have to, must, will, should                                                \\
\end{vocabularytable}
