...
\begin{supertabular}{p{5,5cm}|ll}
    ...
    pona - mi pona e ijo.               &  & transitive verb   \\ % no-dictionary
    The second sina - sina telo e sina. &  & reflexive pronoun \\ % no-dictionary
    ilo - ona li pona e ilo.            &  & noun              \\ % no-dictionary
\end{supertabular}
...
\begin{supertabular}{p{5,5cm}|ll}
    kama - mi kama jo e telo.  &  & auxiliary verb                  \\ % no-dictionary
    wile - mi wile lukin e ma. &  & auxiliary verb, transitive verb \\ % no-dictionary
    ike - mi lawa ike e jan.   &  & adverb                          \\ % no-dictionary
    jan - mi ' jan.            &  & adjective, noun                 \\ % no-dictionary
\end{supertabular}
...
\begin{supertabular}{p{5,5cm}|ll}
    ...
    How do you answer in Toki Pona negative to a yes/no question?   &  & One repeats the predicate or the auxiliary of the question and adds \textit{ala}. \\ % no-dictionary
    How do you answer positively to a yes/no question in Toki Pona? &  & One repeats the predicate or the auxiliary of the question.                       \\ % no-dictionary
\end{supertabular}
...
\begin{supertabular}{p{5,5cm}|ll}
    ...
    This is mine.           &  & mi jo e ni.                            \\ % & English - Toki Pona
\end{supertabular}
